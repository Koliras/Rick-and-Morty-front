      ...
      <CardContent>
        ...
        >
          ...
          <Box>
            ...
            <Typography variant='body1'>{firstSeen}</Typography>
          </Box>
        </Box>
        ...
        <Box>
          ...
          <Typography variant='body1'>
            ...
            illum libero at quisquam eaque officiis amet rem vero voluptatem
            itaque a nihil placeat nam, dolor est consequatur suscipit dicta
            quis. Illo esse, hic veritatis blanditiis vero corrupti rerum quia
            officia libero perferendis provident consequuntur minus culpa dolor
            neque error consectetur adipisci quod autem accusamus doloremque
            unde eos distinctio. Alias, cum.
          </Typography>
        </Box>
      </CardContent>
    </Card>
